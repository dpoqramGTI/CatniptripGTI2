...
// * Falta el script general que maneja las diferentes mec�nicas del enemigo
public class GenericEnemy : MonoBehaviour
{
    ...
    // Checkpoints por los que patrullar� el enemigo
    ...
    {
        Debug.Log("Te estan haciendo :" + ammount + " pts de da�o");
        hitPoints -= ammount;
